    ...
    return (
      <div>
        <div className={styles.banner}>
          <span className={styles.subtitle}>{Resources.pages.sponsorship}</span>
          <span className={styles.title}>
            {Resources.titles.sponsorship}
          </span>
          ...
          <div className="mt5 relative">
            <div className={styles.textSection}>
              <p className={styles.textAbout}>
                {Resources.info.sponsorship}
              </p>
            </div>
            <div className="flex">
              <div className={styles.numbers}><p className="f1 fw7 mv0">+5000</p><p className="mv0 f4 pl2">{Resources.info.attendees}</p></div>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th scope="col">diamond <span>USD 10.000</span></th>
                <th scope="col">gold <span>USD 5.000</span></th>
                <th scope="col">silver <span>USD 2.500</span></th>
                <th scope="col">digital <span>USD 1.000</span></th>
              </tr>
            </thead>
            <tbody>
              <tr>
