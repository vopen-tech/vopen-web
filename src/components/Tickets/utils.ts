 ...
 */
function isTicketSaleOpen(ticketInfo: IEditionTicket): boolean {
 ...
 */
function isTicketSaleFinished(ticketInfo: IEditionTicket): boolean {
  const now = new Date().toISOString();
 ...
 */
function isTicketSaleClosed(ticketInfo: IEditionTicket): boolean {
  const now = new Date().toISOString();
